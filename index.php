...
<HTML>
	<HEAD>
		<TITLE>Inger Smit Home</TITLE>
        <link href="stylesheet.css" rel="stylesheet" type="text/css" media="screen">
        <meta name="robots" content="all"/>
        <meta name="googlebot-news" content="noindex">
    </HEAD>
	<BODY>
		<header><?php include "header.inc";?></header>
        <nav><?php include "menu.inc";?></nav>
        <div id="content">
            <H1>Home</H1>
            <div id="home">
            <section id="welkom">
                ...
                <div class="card">
                    ...
                    <P>
                        If you want to work together on a great project or talk about something interesting don’t hesitate to shoot me a message!
                    </P>
                </div>
            </section>
            </div>
